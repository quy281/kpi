...
### MD-to-Webapp Flow
Khi user cung cấp file `.md` mô tả dự án → **BẮT BUỘC** đọc skill `md-to-webapp` (`d:\fadi-tracker\.agents\skills\md-to-webapp\SKILL.md`) và chạy workflow `/build-from-md` để scaffold webapp tự động.
